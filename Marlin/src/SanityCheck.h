...
*/
  ...
  #if ENABLED(FYS_STORAGE_USBMODE)&&ENABLED(FYS_STORAGE_SDCARD)
    #error "You can only choose FYS_STORAGE_USBMODE or FYS_STORAGE_SDCARD"
  #endif
#endif
/**
 * SD File Sorting
 ...
 */
  ...
  #elif DISABLED(SDSUPPORT) && DISABLED(FYS_STORAGE_SUPPORT) && DISABLED(PRINTJOB_TIMER_AUTOSTART)
    #error "FILAMENT_RUNOUT_SENSOR requires SDSUPPORT ,FYS_STORAGE_SUPPORT or PRINTJOB_TIMER_AUTOSTART."
 ...
 */
  ...
  #elif ENABLED(PARK_HEAD_ON_PAUSE) && DISABLED(SDSUPPORT)&& DISABLED(FYS_STORAGE_SUPPORT) && DISABLED(NEWPANEL) && DISABLED(EMERGENCY_PARSER)
    #error "PARK_HEAD_ON_PAUSE requires SDSUPPORT,FYS_STORAGE_SUPPORT, EMERGENCY_PARSER, or an LCD controller."
...
// Sensorless homing is required for both combined steppers in an H-bot
  ...
  #error "SENSORLESS_HOMING requires TMC2130 TMC2209 or TMC2660 stepper drivers."
#endif
...
#if ENABLED(POWER_LOSS_RECOVERY) && !ENABLED(ULTIPANEL) && !ENABLED(FYSTLCD_V1)
