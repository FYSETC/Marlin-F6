...
#if defined(FYSTLCD_V1) || defined(ENABLE_ULTILCD2)

#elif ENABLED(ULTRA_LCD) || ENABLED(MALYAN_LCD)
  void lcd_init();
  bool lcd_detected();
  void lcd_update();
...
#if DISABLED(FYSTLCD_V1) && DISABLED(ENABLE_ULTILCD2)
