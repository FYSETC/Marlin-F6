 ...
 */
  ...
  #elif DISABLED(SDSUPPORT) && DISABLED(FYS_USBDISK) && DISABLED(PRINTJOB_TIMER_AUTOSTART)
    #error "FILAMENT_RUNOUT_SENSOR requires SDSUPPORT ,FYS_USBDISK or PRINTJOB_TIMER_AUTOSTART."
 ...
 */
  ...
  #elif ENABLED(PARK_HEAD_ON_PAUSE) && DISABLED(SDSUPPORT)&& DISABLED(FYS_USBDISK) && DISABLED(NEWPANEL) && DISABLED(EMERGENCY_PARSER)
    #error "PARK_HEAD_ON_PAUSE requires SDSUPPORT,FYS_USBDISK, EMERGENCY_PARSER, or an LCD controller."
