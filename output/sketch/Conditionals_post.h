...
// Trinamic Stepper Drivers
#if HAS_TRINAMIC
  #define TMC_HAS_SPI     (HAS_DRIVER(TMC2130) || HAS_DRIVER(TMC2660) || HAS_DRIVER(TMC5160))
  #define HAS_STALLGUARD  (HAS_DRIVER(TMC2130) || HAS_DRIVER(TMC2660) || HAS_DRIVER(TMC5160))
  #define HAS_STEALTHCHOP (HAS_DRIVER(TMC2130) || HAS_DRIVER(TMC2208) || HAS_DRIVER(TMC5160))
  #define AXIS_HAS_SPI(ST)         (AXIS_DRIVER_TYPE(ST, TMC2130) || AXIS_DRIVER_TYPE(ST, TMC2660) || AXIS_DRIVER_TYPE(ST, TMC5160))
  #define AXIS_HAS_STALLGUARD(ST)  (AXIS_DRIVER_TYPE(ST, TMC2130) || AXIS_DRIVER_TYPE(ST, TMC2660) || AXIS_DRIVER_TYPE(ST, TMC5160))
  #define AXIS_HAS_STEALTHCHOP(ST) (AXIS_DRIVER_TYPE(ST, TMC2130) || AXIS_DRIVER_TYPE(ST, TMC2208) || AXIS_DRIVER_TYPE(ST, TMC5160))
  ...
  #endif
  #define X_SENSORLESS (AXIS_HAS_STALLGUARD(X) && (defined(X_STALL_SENSITIVITY)||defined(X_HOMING_SENSITIVITY)))
  #define Y_SENSORLESS (AXIS_HAS_STALLGUARD(Y) && (defined(Y_STALL_SENSITIVITY)||defined(Y_HOMING_SENSITIVITY)))
  #define Z_SENSORLESS (AXIS_HAS_STALLGUARD(Z) && (defined(Z_STALL_SENSITIVITY)||defined(Z_HOMING_SENSITIVITY)))
#endif
