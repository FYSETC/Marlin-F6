...
static void lcd_implementation_status_screen() {
  ...
  //
    ...
    #if LCD_WIDTH >= 20 && (ENABLED(SDSUPPORT) || ENABLED(FYS_STORAGE_SUPPORT))
    ...
    #endif // LCD_WIDTH >= 20 && (SDSUPPORT || FYS_STORAGE_SUPPORT)
  ...
  #elif ENABLED(FILAMENT_LCD_DISPLAY) && (ENABLED(SDSUPPORT) || ENABLED(FYS_STORAGE_SUPPORT))
  ...
  #endif // FILAMENT_LCD_DISPLAY && (SDSUPPORT || FYS_STORAGE_SUPPORT)
