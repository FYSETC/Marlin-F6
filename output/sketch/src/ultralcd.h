...
------------------------------------------*/
  ...
  #define   lcd_popup(x)    lcd_setstatusPGM(PSTR(x))
  #define lcd_shutDown()
  #define dwin_popup_shutdown()
...
* fzl : FYSTLCD
------------------------------------------*/
#elif defined(FYSTLCD_V1) // ULTRA_LCD  #elif defined(MINIPANEL)
...
#if ENABLED(FYSTLCD_V1) || defined(MINIPANEL) || defined(ENABLE_ULTILCD2)
...
#if (ENABLED(ULTIPANEL)||ENABLED(FYSTLCD_V1)) && (ENABLED(SDSUPPORT) || ENABLED(FYS_STORAGE_SUPPORT))
