...
//    #define X_ENABLE_WRITE(STATE) do{ WRITE(X_ENABLE_PIN,STATE);stepperX.toff((STATE)==X_ENABLE_ON ? stepperX.savedToff() : 0);} while(0)    
...
// Y Stepper
  ...
  #define Y_DIR_READ (stepperY.getStatus() & STATUS_DIR)
    ...
    //#define Y_ENABLE_WRITE(STATE) do{ WRITE(Y_ENABLE_PIN,STATE);stepperY.toff((STATE)==Y_ENABLE_ON ? stepperY.savedToff() : 0);} while(0)
...
//    #define Z_ENABLE_WRITE(STATE) do{ WRITE(Z_ENABLE_PIN,STATE);stepperZ.toff((STATE)==Z_ENABLE_ON ? stepperZ.savedToff() : 0);} while(0)     
...
//      #define X2_ENABLE_WRITE(STATE) do{ WRITE(X2_ENABLE_PIN,STATE);stepperX2.toff((STATE)==X2_ENABLE_ON ? stepperX2.savedToff() : 0);} while(0)    
...
//      #define Y2_ENABLE_WRITE(STATE) do{ WRITE(Y2_ENABLE_PIN,STATE);stepperY2.toff((STATE)==Y2_ENABLE_ON ? stepperY2.savedToff() : 0);} while(0)    
...
//      #define Z2_ENABLE_WRITE(STATE) do{ WRITE(Z2_ENABLE_PIN,STATE);stepperZ2.toff((STATE)==Z2_ENABLE_ON ? stepperZ2.savedToff() : 0);} while(0)    
...
//    #define E0_ENABLE_READ stepperE0.isEnabled()
    ...
    //#define E0_ENABLE_WRITE(STATE) do{ WRITE(E0_ENABLE_PIN,STATE);stepperE0.toff((STATE)==E_ENABLE_ON ? stepperE0.savedToff() : 0);} while(0)    
...
//    #define E1_ENABLE_WRITE(STATE) do{ WRITE(E1_ENABLE_PIN,STATE);stepperE1.toff((STATE)==E_ENABLE_ON ? stepperE1.savedToff() : 0);} while(0)    
...
//    #define E2_ENABLE_WRITE(STATE) do{ WRITE(E2_ENABLE_PIN,STATE);stepperE2.toff((STATE)==E_ENABLE_ON ? stepperE2.savedToff() : 0);} while(0)    
...
//    #define E3_ENABLE_WRITE(STATE) do{ WRITE(E3_ENABLE_PIN,STATE);stepperE3.toff((STATE)==E_ENABLE_ON ? stepperE3.savedToff() : 0);} while(0)    
...
//    #define E4_ENABLE_WRITE(STATE) do{ WRITE(E4_ENABLE_PIN,STATE);stepperE4.toff((STATE)==E_ENABLE_ON ? stepperE4.savedToff() : 0);} while(0)    
